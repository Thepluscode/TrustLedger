...
Backend: **107 tests, 0 failures** — pure-domain unit tests plus **Testcontainers** integration
across **PostgreSQL & Redpanda**.

```bash
cd backend && mvn test     # Tests run: 107, Failures: 0, Errors: 0, Skipped: 0  (2026-06-09)
