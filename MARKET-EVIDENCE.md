...
|-----|-------|--------------------------------------------------|
| contacted | 15 | 2026-08-04: 17 companies emailed, 15 delivered. PalmPay and MultiBank bounced on every address tried and have no email route. Named recipients, sources and confidence per company in `pilot/sends/batch-01-recipients.md` and `batch-02-03-recipients.md`; Gmail message IDs in the tracker. |
| conversations | 0 | No reply from any of the 15 at four days. Verified against Gmail Sent/Inbox on 2026-08-06 and 2026-08-08, not assumed from silence. |
| confirmed_pain | 0 | |
| requested | 0 | |
| committed | 0 | |
...
**Status:** UNTESTED
163 commits in 90 days — the largest engineering investment in the portfolio — against 15
delivered emails and 0 replies. The premise kill-test (`pilot/PREMISE_KILL_TEST.md`) is the
