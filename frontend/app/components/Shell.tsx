...
const NAV: { label: string; links: [string, string][] }[] = [
  { label: "Overview", links: [["Dashboard", "/dashboard"], ["Getting Started", "/onboarding"]] },
  {
    ...
    links: [
      ...
      ["Settlements", "/reconciliation/statements"],
    ],
  },
  {
    label: "Fraud",
  ...
  { label: "Developer", links: [["API Keys", "/developer/api-keys"], ["Monitoring", "/monitoring"]] },
  { label: "Organisation", links: [["Tenant Admin", "/admin"], ["Users & Roles", "/users"], ["Org Units", "/org-units"]] },
];
