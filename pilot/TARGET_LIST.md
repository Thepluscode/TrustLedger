...
|---|---|---|---|---|
| 1 | **PalmPay** | Multi-country payments business with a currently public dispute/chargeback and reconciliation analyst, plus public operator discussion of settlement, reversals and fee calculations. This proves a dedicated workflow exists; it does not prove pain, recurrence, data access or budget. | [Friday Ogungbemi](https://ng.linkedin.com/in/friday-ogungbemi-8a5055191) · [Precious Eguda](https://ng.linkedin.com/in/precious-eguda-05427a1a4), retrieved 2026-08-12 | **Interview #1.** Operator-first LinkedIn/warm-intro path in `INTERVIEW_01_PALMPAY.md`; no verified email route. |
